# CHANGES: Use torch.optim instead of manually implemented optimizer
import time
import copy
import torch
...
def train(seed=0):
    ...
    # Create optimizers for weights and biases separately
    # Filter parameters into weights and biases
    ...
    for epoch in range(1, epochs + 1):
        ...
        for i in range(0, len(valid_data), batch_size):
            ...
            # Test time augmentation: Test model on regular and flipped data
